...
import 'package:state_management/features/apple_store/state_management/getx/cart_get_controller.dart';

void main() {
  group('CartGetController Tests', () {
    late CartGetController controller;
    final product = dummyProducts[0];
    final color = product.availableColors[0];
    final storage = product.storageOptions[0];

    setUp(() {
      controller = CartGetController();
    });
